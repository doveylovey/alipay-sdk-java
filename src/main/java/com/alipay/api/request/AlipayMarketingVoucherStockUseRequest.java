 ...
 */
public class AlipayMarketingVoucherStockUseRequest implements AlipayRequest<AlipayMarketingVoucherStockUseResponse> {
    ...
    public Class<AlipayMarketingVoucherStockUseResponse> getResponseClass() {
        return AlipayMarketingVoucherStockUseResponse.class;
    }
