...
import com.alipay.api.domain.AlipayOpenAppSystemNewcontextupiduoidTransferModel;

import java.util.Map;

import com.alipay.api.AlipayRequest;
import com.alipay.api.internal.util.AlipayHashMap;
import com.alipay.api.response.AlipayOpenAppSystemNewcontextupiduoidTransferResponse;
...
public class AlipayOpenAppSystemNewcontextupiduoidTransferRequest implements AlipayRequest<AlipayOpenAppSystemNewcontextupiduoidTransferResponse> {
    ...
    public Class<AlipayOpenAppSystemNewcontextupiduoidTransferResponse> getResponseClass() {
        return AlipayOpenAppSystemNewcontextupiduoidTransferResponse.class;
    }
