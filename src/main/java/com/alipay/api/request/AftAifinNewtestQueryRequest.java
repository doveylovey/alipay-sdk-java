...
import com.alipay.api.response.AftAifinNewtestQueryResponse;
...
public class AftAifinNewtestQueryRequest implements AlipayRequest<AftAifinNewtestQueryResponse> {
    ...
    public Class<AftAifinNewtestQueryResponse> getResponseClass() {
        return AftAifinNewtestQueryResponse.class;
    }
