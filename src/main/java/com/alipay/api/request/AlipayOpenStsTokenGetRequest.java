...
import com.alipay.api.response.AlipayOpenStsTokenGetResponse;
...
public class AlipayOpenStsTokenGetRequest implements AlipayRequest<AlipayOpenStsTokenGetResponse> {
    ...
    public Class<AlipayOpenStsTokenGetResponse> getResponseClass() {
        return AlipayOpenStsTokenGetResponse.class;
    }
