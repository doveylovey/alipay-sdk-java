 ...
 */
public class AlipayUserCertifyOpenCertifyRequest implements AlipayRequest<AlipayUserCertifyOpenCertifyResponse> {
    ...
    public Class<AlipayUserCertifyOpenCertifyResponse> getResponseClass() {
        return AlipayUserCertifyOpenCertifyResponse.class;
    }
